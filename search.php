<?php 
    ...
    (isset($_POST['Keyword'])) ? $Keyword = $_POST['Keyword'] : Reconect('post.php');
...
<!-- main content -->
 <main class="col-md-9 ms-sm-auto col-lg-10  px-md-0" >
    <div class="header_img bg-dark ">
        <div class="row mx-0 m-0 p-0">
            <div class="col-8  m-0 p-0"style="background-image: url('assets/brand/cat1.jpg');">
                <h1 class="text-white h2"><?=$Keyword?></h1>                
            </div>
              ...
              <div class="container-fluid">               
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                      <ul class="navbar-nav align-items-end">
                        <?php 
                            $data = SelectData('blogs_category','');
    ...
    <div class="bg-dark d-md-none d-sm-block" ><h6 class="text-white p-2">NEWS</h6></div>
 	<!-- detail content -->
 	<div class="row mx-0 bg-dark px-md-4 px-sm-0 pb-5" style="min-height: 800px;">
 		 <!--short sidebar -->
 		...
 		<div class="col-12 mt-md-2 col-md-10 col-lg-10 m-0 p-0">
 			<div class="cat_content " style="min-height: 800px;">
                ...
                <div class="row p-3">
                    ...
                    <?php 
                    $data = SelectData('blog_news',"WHERE post_title LIKE '%$Keyword%' OR blognews_content LIKE '%$Keyword%' OR datetime LIKE '%$Keyword%' ");
                    while($row = $data->fetch_object()){?> 
