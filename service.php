                ...
                <div class="collapse navbar-collapse " id="navbarNav">
                      <ul class="navbar-nav align-items-end">
                        <?php 
                            ...
                            <li class="nav-item">
                              <a class="nav-link  text-white"  href="service.php?service=<?=$serviceid?>"><?=$row->sub_name;?></a>
                            </li>
                            <?php }?>
                      </ul>
                </div>
 	...
 	<div class="row mx-0 bg-dark px-md-4">
 		...
 		<div class="col-2 mt-2  p-0 h-50  side-menu ">
            <ul class="nav flex-column main_header">
                ...
                <li class="nav-item">
                    <a class="nav-link nav_menu  active_menu" href="service.php?service=<?=$serviceid?>&services=<?=$row->sub_id;?>"><?=$row->sub_name;?></a>
                </li>
        ...
        <?php 
            ...
            if (!isset($_GET['services'])) {
                $service_data = SelectData('services', "WHERE catagory='$serviceid' AND Language='0' ");
            }else{
                $service_data = SelectData('services', "WHERE subcatagory={$_GET['services']} AND Language='0'");
        ...
        ?>
 		...
 		<div class="col-12 mt-md-2 col-md-10 col-lg-10 m-0 p-0 mb-5">
 			<div class="cat_content ">                 
                ...
                <div class="row mx-0 my-3 p-3 ">                  
                    ...
                    <div class="lawyer col-12 col-md-2 bg-light m-0 p-0">
                        ...
                        <div class="card m-0 p-0 text-center" style="border: 1px solid red;">
                        ...
                        <div class="Reletedservice">
                         <b class="p-2 bg-danger mt-2 d-block text-white">Related Service</b>
                            <ul class="">
                                <li><a class="text-danger" href="">What is Lorem Ipsum Test</a></li>
                            </ul>
                        </div>
