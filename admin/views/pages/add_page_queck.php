            ...
            <div class="container my-5">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control  mb-4 " name="page_url"> 
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">                       
                        ...
                        <input type="date" class="form-control mb-4" value="<?=date('m/d/Y');?>" id="date" name="date">
                    </div>
                    <div class="col-12 col-md-6">
                        <label for="icon" class=" form-label" style="font-weight:700;">Menu icon</label>
                        <input type="text" class="form-control  mb-4" value="Icon" id="menu_icon" name="menu_icon">
                    </div>
                </div>
