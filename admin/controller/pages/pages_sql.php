 ...
 //Page add----------------------------------------
    if (isset($_POST['page_add'])) {
        ...
        $insert = "INSERT INTO pages ( manu_title, page_url, date, menu_icon, page_parent_id, page_status ) VALUES ( '$manu_title', '$page_url', '$date', '$menu_icon', '$page_parent_id', '$page_status' )";
    ...
    if (isset($_POST['page_edit'])) {
        ...
        $update = "UPDATE pages  SET manu_title='$manu_title', page_url='$page_url', date='$date', menu_icon='$menu_icon', page_parent_id='$page_parent_id', page_status='$page_status' WHERE page_id='$page_id'";
